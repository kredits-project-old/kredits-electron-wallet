...
<q-page>
    <div class="q-mx-md import-wallet">
        ...
        <KreditsField :label="$t('fieldLabels.newWalletName')" :error="$v.wallet.name.$error">
            <q-input
                v-model="wallet.name"
        ...
        <KreditsField :label="$t('fieldLabels.walletFile')" disable-hover>
            <q-input
                v-model="wallet.path"
        ...
        <KreditsField :label="$t('fieldLabels.password')">
            <q-input
        ...
        <KreditsField :label="$t('fieldLabels.confirmPassword')">
