...
<q-page class="create-wallet">
    <div class="fields q-mx-md q-mt-md">
        <KreditsField :label="$t('fieldLabels.walletName')" :error="$v.wallet.name.$error">
            <q-input
                v-model="wallet.name"
        ...
        <KreditsField :label="$t('fieldLabels.seedLanguage')">
            <q-select
        ...
        <KreditsField :label="$t('fieldLabels.password')" optional>
            <q-input
