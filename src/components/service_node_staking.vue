...
<div class="service-node-staking">
    <div class="q-pa-md">
        <KreditsField :label="$t('fieldLabels.serviceNodeKey')" :error="$v.service_node.key.$error">
        ...
        <KreditsField :label="$t('fieldLabels.amount')" class="q-mt-md" :error="$v.service_node.amount.$error">
