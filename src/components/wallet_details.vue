...
<div class="column wallet-info">
    <div class="row justify-between items-center wallet-header kredits-green">
    ...
    <div class="wallet-content">
        <div class="row justify-center">
            <div class="funds column items-center">
                <div class="balance">
                    <div class="text"><span>{{ $t("strings.kreditsBalance") }}</span></div>
                    <div class="value"><span><FormatKredits :amount="info.balance" /></span></div>
                </div>
                <div class="row unlocked">
                    <span>{{ $t("strings.kreditsUnlockedShort") }}: <FormatKredits :amount="info.unlocked_balance" /></span>
                </div>
            </div>
        </div>
...
import FormatKredits from "components/format_kredits"
