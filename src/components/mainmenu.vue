...
<div>
    ...
    <q-modal minimized ref="aboutModal">
        <div class="about-modal">
            ...
            <img class="q-mb-md" src="statics/kredits.svg" height="42" />

            <p class="q-my-sm">Wallet Version: v{{version}}</p>
            <p class="q-my-sm">Daemon Version: v{{daemonVersion}}</p>
			<p class="q-my-sm">Copyright (c) 2019, Kredits Project</p>
            ...
            <div class="q-mt-md q-mb-lg external-links">
                <p>
                    <a @click="openExternal('https://kredits.cc/')" href="#">https://kredits.cc/</a>
                </p>
                <p>
                    <a @click="openExternal('https://discordapp.com/invite/6bSFRvq')" href="#">Discord</a> -
                    <a @click="openExternal('https://github.com/kredits-project/kredits-electron-wallet')" href="#">Github</a>
                </p>
            </div>
