export default {
    ...
    menuItems: {
        ...
        exit: "Quitter le portefeuille Kredits GUI",
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "kreditsd introuvable, utilisation du nœud distant"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        kreditsBalance: "Solde",
        kreditsUnlockedBalance: "Solde débloqué",
        kreditsUnlockedShort: "Débloqué",
