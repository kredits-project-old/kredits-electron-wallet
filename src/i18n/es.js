export default {
    ...
    menuItems: {
        ...
        exit: "Cerrar la interfaz del monedero Kredits",
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "kreditsd no encontrado, utilizando nodo remoto"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        kreditsBalance: "Saldo",
        kreditsUnlockedBalance: "Saldo libre",
        kreditsUnlockedShort: "Libre",
        ...
        serviceNodeRegistrationDescription: "Introduzca la orden {registerCommand} generada por el servicio (kreditsd) que se está intentado registrar como Nodo de Servicio usando la instrucción \"{prepareCommand}\"",
        spendKey: "Clave de gasto",
