export default {
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "kreditsd not found, using remote node"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        kreditsBalance: "Balance",
        kreditsUnlockedBalance: "Unlocked balance",
        kreditsUnlockedShort: "Unlocked",
