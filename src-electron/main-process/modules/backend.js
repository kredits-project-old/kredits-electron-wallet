...
export class Backend {
    ...
    init (config) {
        if (os.platform() === "win32") {
            this.config_dir = "C:\\ProgramData\\kredits"
            this.wallet_dir = `${os.homedir()}\\Documents\\kredits`
        } else {
            this.config_dir = path.join(os.homedir(), ".kredits")
            this.wallet_dir = path.join(os.homedir(), "kredits")
        }
